...
<div id="wrap">
	<div class="wppsac-sf-wrap">
		<div class="wppsac-sf-inr">
			...
			<!-- <h1 class="wppsac-sf-heading">Only <span class="wppsac-sf-blue">November 2022</span> Deal <span class="wppsac-sf-blue">40% OFF</span></h1>
				...
				<h2>With <span class="wppsac-blue">35+ plugins</span>, <span class="wppsac-blue">2000+ templates</span> & $600 saving in <span class="wppsac-blue">Essential Plugin Bundle</span></h2>
				<h3><span style="text-decoration:line-through; color: #FF1000;">$299</span> <span class="wppsac-blue" style="font-size:30px;">$179</span> Unlimited Site License</h3>
				<a href="<?php //echo WPRPS_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wppsac-sf-btn wppsac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle Deal</a>
				...
				<p style="font-weight: bold !important; font-size:20px !important;"><span style="color: #50c621;">Essential Plugin Bundle</span> + Any Leading Builders (Avada / Elementor / Divi / <br>VC-WPBakery / Site Origin / Beaver) = <span style="background: #50c621;color: #fff;padding: 2px 10px;">WordPress Magic</span></p>
					...
					<a href="<?php echo WPRPS_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wppsac-sf-btn wppsac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
			</div>
			<div class="wppsac-sf-features-section wppsac-sf-team wppsac-sf-center">
				<h1 class="wppsac-sf-heading">Powerful Team Behind <span class="wppsac-sf-blue">Post Slider</span> Including in <span class="wppsac-sf-blue">Essential Plugin Bundle</span></h1>
			...
			<div class="wppsac-sf-welcome-wrap">
				<div class="wppsac-sf-welcome-inr wppsac-sf-center">
						...
						<a href="<?php echo esc_url( $wppsac_add_link ); ?>" class="wppsac-sf-btn">Launch Post Slider With Free Features</a> <br /><b>OR</b> <br /> <a href="<?php echo WPRPS_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wppsac-sf-btn wppsac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
			...
			<div class="wppsac-features-section">
				...
				<div class="wppsac-sf-welcome-wrap wppsac-sf-center">
					...
					<p style="font-size: 14px;"><span class="wppsac-sf-blue">Post Slider </span>Including in <span class="wppsac-sf-blue">Essential Plugin Bundle</span></p>
					<a href="<?php echo WPRPS_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wppsac-sf-btn wppsac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
					<div class="wppsac-rc-wrap">
						<div class="wppsac-rc-inr wppsac-rc-bg-box">
							<div class="wppsac-rc-icon">
			...
			<div class="wppsac-sf-testimonial-wrap">
				<div class="wppsac-center wppsac-features-ttl">
					<h1 class="wppsac-sf-heading">Seamless Integration With All Major <span class="wppsac-sf-blue">Page Builders</span></h1>	
					<div class="wppsac-sf-cont wppsac-center" style="text-align:center;">Compatible with Gutenberg, DIVI, Elementor, Avada, VC/WPbakery etc page builder/themes</div>
					<div class="wppsac-sf-welcome-wrap wppsac-center">
						<img src="<?php echo esc_url( WPRPS_URL ); ?>assets/images/page-builder-icon.png" alt="page-builder-icon" title="page-builder-icon" />	
					</div>	
				</div>
			...
			<div class="wppsac-sf-testimonial-wrap">
				<div class="wppsac-center wppsac-features-ttl">
					<h1 class="wppsac-sf-heading">Looking for a Reason to Use <span class="wppsac-sf-blue">Essential Plugin</span> with <span class="wppsac-sf-blue">Recent Post Slider?</span></h1>
					<p style="text-align:center"> Here are 80+...</p>
				</div>
				<div class="wppsac-testimonial-section-inr">
					...
					<a href="https://wordpress.org/support/plugin/wp-responsive-recent-post-slider/reviews/?filter=5" target="_blank" class="wppsac-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a>
					<p style="font-size: 14px;"><span class="wppsac-sf-blue">Post Slider </span>Including in <span class="wppsac-sf-blue">Essential Plugin Bundle</span></p>		
					<a href="<?php echo WPRPS_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wppsac-sf-btn wppsac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
					<div class="wppsac-rc-wrap">
						<div class="wppsac-rc-inr wppsac-rc-bg-box">
